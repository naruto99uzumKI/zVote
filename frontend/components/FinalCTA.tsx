...
export const FinalCTA: React.FC<FinalCTAProps> = ({ onLaunchApp }) => {
  return (
    <section className="relative py-40 flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <Button icon className="w-full sm:w-auto px-10 py-4 text-base shadow-glow-blue" onClick={onLaunchApp}>Launch zVote</Button>
